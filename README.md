...
### Desenvolvedor em formação | Java | Tecnologia da Informação
...
Tenho foco em **Java Orientado a Objetos**, boa capacidade de aprendizado e vontade constante de evoluir tecnicamente.
...
## 📚 Formação & Cursos
- 🎓 Técnico em Informática – **ETEC** (Concluído – 2025)  
- 📘 Java Fundamentals – **SENAI** (2025)  
- 📘 Java POO – **Udemy** (Em andamento)  
- 📘 Lógica de Programação – **SENAI** (2024)  
- 📘 AI-900 – **SENAI** (2025)  
- 📘 Design Thinking – **Udemy** (2024)  
